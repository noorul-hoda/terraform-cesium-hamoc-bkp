...
cidr          = "10.2.0.0/22"
priv-subnet   = ["10.2.0.0/25", "10.2.0.128/25", "10.2.1.0/25"]
pub-subnet    = ["10.2.1.128/25", "10.2.2.0/25", "10.2.2.128/25"]

##R53 Hosted Zone Domain Name Variable
website-domain-main = "dev.cesium.trilateral.ai"
ecs-domain-name     = "ecs.dev.cesium.trilateral.ai"
api-domain-name     = "api.dev.cesium.trilateral.ai"

##RDS Variables
db-username       = "cesiumdevadmin"
db-password       = "DevCesium2021"
...
cgw-onprem-ip          = "" //Should be blank for dev environment
onprem-cidr-block      = [] //Should be blank for dev environment
