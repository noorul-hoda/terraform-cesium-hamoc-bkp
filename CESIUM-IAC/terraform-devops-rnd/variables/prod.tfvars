...
instance-type-etl = "t2.large"
cidr          = "10.0.0.0/22"
priv-subnet   = ["10.0.0.0/25", "10.0.0.128/25", "10.0.1.0/25"]
pub-subnet    = ["10.0.1.128/25", "10.0.2.0/25", "10.0.2.128/25"]

##R53 Hosted Zone Domain Name Variable
website-domain-main = "cesium.trilateral.ai"
ecs-domain-name     = "ecs.cesium.trilateral.ai"
api-domain-name     = "api.cesium.trilateral.ai"

##RDS Variables
db-username       = "cesiumprodadmin"
db-password       = "CesiumProd2021"
db-username-etl       = "cesiumetladmin"
db-password-etl       = "CesiumEtlTest2021"
...
ecs-repo_name = "devops-rnd/demo-ecs" //In format "/<workspace-id>/<bitbucket-reponame>"
...
cf_whitelist_ipv4-list = [
  #"93.70.156.138/32", #Aliai
  "81.2.162.201/32",  #Anita
  "188.221.59.134/32", #Ezra
  "109.255.54.28/32", #Mick
  "82.30.85.128/32",  #Noor
  "209.93.73.211/32", #Rob
  "78.149.170.210/32", #Sam
  "5.252.220.36/32"    #Tri Office
]
