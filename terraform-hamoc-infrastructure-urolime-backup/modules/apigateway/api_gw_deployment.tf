...
resource "aws_api_gateway_deployment" "api" {
  ...
  triggers = {
    redeployment = sha1(jsonencode([
      ...
      aws_api_gateway_resource.notificationCenter,
      aws_api_gateway_resource.notificationCenter_ProxyResource,
      aws_api_gateway_resource.notificationCenter_ProxyResource,
      aws_api_gateway_method.notificationCenter_ProxyResource-ANY,
      aws_api_gateway_integration.notificationCenter_ProxyResource-ANY,
      aws_api_gateway_method.notificationCenter_ProxyResource-OPTIONS,
      aws_api_gateway_integration.notificationCenter_ProxyResource-OPTIONS,
      ...
      aws_api_gateway_resource.orgManagement,
      aws_api_gateway_resource.orgManagement_ProxyResource,
      aws_api_gateway_resource.orgManagement_ProxyResource,
      aws_api_gateway_method.orgManagement_ProxyResource-ANY,
      aws_api_gateway_integration.orgManagement_ProxyResource-ANY,
      aws_api_gateway_method.orgManagement_ProxyResource-OPTIONS,
      aws_api_gateway_integration.orgManagement_ProxyResource-OPTIONS
    ]))
  }
