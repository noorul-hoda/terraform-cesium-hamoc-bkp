...
##VPC Variables
cidr                   = "10.11.0.0/16"
priv-subnet            = ["10.11.0.0/24", "10.11.1.0/24", "10.11.2.0/24"]
pub-subnet             = ["10.11.3.0/24", "10.11.4.0/24", "10.11.5.0/24"]
...
##RDS Variables
db-username       = "hamocdemoadmin"
db-password       = "HamocDemo2021"
...
website-domain-main = "demo.hamoc.trilateral.ai"
ecs-domain-name     = "ecs.demo.hamoc.trilateral.ai"
api-domain-name     = "api.demo.hamoc.trilateral.ai"
