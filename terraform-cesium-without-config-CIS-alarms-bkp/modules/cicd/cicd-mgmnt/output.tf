...
output "ml_lambda_codebuild_loggroup" {
  value = aws_cloudwatch_log_group.ml_lambda_codebuild.name
}

output "ml_lambda_codebuild_loggroup_arn" {
  value = aws_cloudwatch_log_group.ml_lambda_codebuild.arn
}